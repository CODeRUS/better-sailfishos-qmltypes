...
Item {
    ...
    SilicaFlickable {
        ...
        PullDownMenu {
            ...
            menuIndicator: Image {
                id: indicator
                source: "image://theme/graphic-pulldown-no-shader?" + tutorialTheme.highlightColor
                anchors {
                ...
                Behavior on scale { NumberAnimation { duration: pulleyMenu.busy ? 450 : 50 } }

                Timer {
                    id: busyTimer
                    running: pulleyMenu.busy
                    interval: 500
                    repeat: true
                    ...
                    onTriggered: {
                        indicator.scale = indicator.scale < 1.0 ? 1.25 : 0.75
                    }
                }
            }
